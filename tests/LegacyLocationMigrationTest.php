...
final class LegacyLocationMigrationTest
{
    ...
    private function createTargetSchema(PDO $pdo): void
    {
        $ddl = [
            ...
            "CREATE TABLE location (id CHAR(36) PRIMARY KEY, dad_number VARCHAR(20) UNIQUE, location_type_id CHAR(36) NOT NULL, official_code VARCHAR(100), name_en VARCHAR(255) NOT NULL, name_si VARCHAR(255), name_ta VARCHAR(255), effective_from DATE NOT NULL, effective_to DATE, operational_status VARCHAR(30), approval_status VARCHAR(30), created_by CHAR(36), created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, updated_by CHAR(36), updated_at TIMESTAMP NULL, version BIGINT DEFAULT 0)",
