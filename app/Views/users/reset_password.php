...
<div class="page-heading"><div><div class="breadcrumb-lite">User Management / Active Users</div><h1>Reset Password</h1><p>Set a temporary password for this user.</p></div></div>
<div class="row g-4">
    <div class="col-12 col-xl-5"><div class="card border-0 shadow-sm"><div class="card-body">
        <h2 class="h6">Account</h2>
        <dl class="row mb-0"><dt class="col-5">Username</dt><dd class="col-7"><?= e($user['username']) ?></dd><dt class="col-5">Display Name</dt><dd class="col-7"><?= e($user['display_name']?:'Not set') ?></dd><dt class="col-5">Status</dt><dd class="col-7"><?= e(ucwords(strtolower(str_replace('_',' ',$user['account_status'])))) ?></dd><dt class="col-5">Roles</dt><dd class="col-7"><?= e($user['effective_roles']?:'None') ?></dd><dt class="col-5">Assigned Locations</dt><dd class="col-7"><?= e($user['effective_scopes']?:'None') ?></dd></dl>
    </div></div></div>
    <div class="col-12 col-xl-7"><div class="card border-0 shadow-sm"><form method="post" action="<?= e(url('access-management/users/'.$user['id'].'/reset-password')) ?>" class="card-body">
        ...
        <div class="mb-3"><label class="form-label">Reference</label><input class="form-control" name="official_reference" maxlength="255"></div>
