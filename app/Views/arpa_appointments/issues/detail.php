...
<div class="page-heading">
  <div><div class="breadcrumb-lite">ARPA Officer Appointments / Data Issues / Review</div><h1><?= e($presentation['title']) ?></h1><p><?= e($presentation['explanation']) ?></p></div>
...
<div class="row g-3 mb-4">
  ...
  <div class="col-lg-4"><div class="form-section h-100">
    <h2 class="h5">Appointment</h2><dl class="row mb-0">
      <dt class="col-5">Officer</dt><dd class="col-7"><a href="<?= e(url('hr/officers/'.$issue['officer_id'])) ?>"><?= e($issue['officer_name']) ?></a></dd>
      ...
      <dt class="col-5">Appointment Type</dt><dd class="col-7"><?= e(str_replace('_',' ',$issue['appointment_types']?:$dash)) ?></dd>
...
<?php foreach($appointments as $a): ?><tr><td><?= e($issue['officer_number'].' - '.$issue['officer_name']) ?></td><td><?= e($a['asc_name_snapshot']) ?><br><strong><?= e($a['arpa_dad_snapshot'].' - '.$a['arpa_name_snapshot']) ?></strong></td><td><?= e(str_replace('_',' ',$a['appointment_type'])) ?></td><td><?= DataTableFormat::date($a['effective_from']) ?> to <?= DataTableFormat::date($a['effective_to'],'Open') ?></td><td><?= (int)$a['legacy_history_only']===1?DataTableFormat::badge('Old Record - History Only'):DataTableFormat::badge('Current Appointment') ?> <?= (int)$a['legacy_exception']===1?DataTableFormat::badge('Old Data Warning'):'' ?></td><td><a class="btn btn-sm btn-outline-primary" href="<?= e(url('hr/arpa-appointments/divisions/'.$a['id'])) ?>">View Appointment</a></td></tr><?php endforeach; ?>
