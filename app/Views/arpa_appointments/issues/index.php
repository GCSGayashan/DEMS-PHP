...
?>
<div class="page-heading"><div><div class="breadcrumb-lite">Human Resource Management / ARPA Officer Assignments</div><h1>Appointment Data Issues</h1><p>Check assignment records that may contain missing or conflicting information.</p></div><?php if(!empty($bulkReconciliationAllowed)): ?><a class="btn btn-warning" href="<?= e(url('hr/arpa-appointments/issues/bulk-current')) ?>">Bulk Legacy Current Reconciliation</a><?php endif; ?></div>
