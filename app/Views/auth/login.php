...
<div class="card-body p-4"><div class="text-center mb-4"><img class="dad-logo dad-logo-auth mb-2" src="<?= e(url('assets/img/dad-logo.png')) ?>" alt="Department of Agrarian Development"><h3 class="mb-1">DEMS</h3><div class="text-muted">Department Enterprise Management System</div></div>
