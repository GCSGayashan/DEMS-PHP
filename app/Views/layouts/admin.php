...
<?php if(Auth::can('officer.office-assignment.create')||Auth::can('officer.office-assignment.approve')): ?><a class="nav-link ps-4 <?= activePath('/hr/officers/unassigned',$path) ?>" href="<?= e(url('hr/officers/unassigned')) ?>"><i class="bi bi-person-plus"></i> Unassigned Officers</a><?php endif; ?>
<?php if(Auth::can('officer.edit-request')||Auth::can('officer.edit-approve')): ?><a class="nav-link ps-4 <?= activePath('/hr/officer-edit-requests',$path) ?>" href="<?= e(url('hr/officer-edit-requests')) ?>"><i class="bi bi-pencil-square"></i> Officer Edit Requests</a><?php endif; ?>
...
<script data-cfasync="false" src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script><script data-cfasync="false" src="<?= e(url('assets/vendor/jquery/jquery.min.js')) ?>"></script><script data-cfasync="false" src="<?= e(url('assets/vendor/datatables/dataTables.min.js')) ?>"></script><script data-cfasync="false" src="<?= e(url('assets/vendor/datatables/dataTables.bootstrap5.min.js')) ?>"></script><script data-cfasync="false" src="<?= e(url('assets/js/dems-datatable.js')) ?>"></script><script data-cfasync="false" src="<?= e(url('assets/js/dems-charts.js')) ?>"></script><script data-cfasync="false" src="<?= e(url('assets/js/app.js')) ?>"></script></body></html>
